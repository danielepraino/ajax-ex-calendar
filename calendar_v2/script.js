...
console.log("momentDate: " + momentDate.month());
...
function calendarPageGen(date, days, obj) {
  for (var i = 1; i <= days; i++) {
    $(".month").text(date.format("MMMM YYYY"));
    obj.dayNum = i;
    obj.holidayDate = date.format("YYYY-MM-") + dateFormatter(i);
...
//CREARE UNA FUNZIONE CHE METTE LO ZERO DAVANTI AL NUMERO DEL GIORNO SE E' MINORE DI 10
//ALTRIMENTI RESTITUISCE IL GIORNO E BASTA
